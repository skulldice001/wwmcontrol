...
import BingoRoom from './components/BingoRoom.vue';
import TienLenRoom from './components/TienLenRoom.vue';
...
app.component('bingo-room', BingoRoom);
app.component('tienlen-room', TienLenRoom);
app.mount('#app');
